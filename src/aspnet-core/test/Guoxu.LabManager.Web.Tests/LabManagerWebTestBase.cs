...
{
    public abstract class LabManagerWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LabManagerWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LabManagerWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LabManagerDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LabManagerDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LabManagerDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LabManagerDbContext, Task<T>> func)
        {
            T result;
