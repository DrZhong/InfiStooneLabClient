        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CurrentSelectedWarehouseType = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReagentCatalog = table.Column<int>(type: "int", nullable: false),
                    CasNo = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
                    ReagentStatus = table.Column<int>(type: "int", nullable: false),
                    CnName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CnAliasName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EnName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SafeAttribute = table.Column<int>(type: "int", nullable: true),
                    StorageAttr = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    InventoryWarning = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reagent_Company_ProductionCompanyId",
                        column: x => x.ProductionCompanyId,
                        principalTable: "Company",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Reagent_Company_SupplierCompanyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reagent_ProductionCompanyId",
                table: "Reagent",
                column: "ProductionCompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_Reagent_SupplierCompanyId",
                table: "Reagent",
