import { OrderConfirmEdInputDto, OutOrderMasterItemStatues, StockoutOrderServiceProxy } from './../../../../shared/service-proxies/service-proxies';
import { Component, Injector, OnInit, ViewChild } from '@angular/core';
import { ShowReagentDetailComponent } from '@app/reagent/shared/show-reagent-detail/show-reagent-detail.component';
import { ReagentStockAuditDialogComponent } from '@app/reagent/stockin/reagent-stock-audit-dialog/reagent-stock-audit-dialog.component';
import { STComponent, STColumn } from '@delon/abc/st';
import { PagedListingComponentBase, PagedRequestDto } from '@shared/component-base/paged-listing-component-base';
import { ReagentStockListDto, ReagentStockStatusEnum, AuditOutOrderMasterItemDto, SafeAttributes } from '@shared/service-proxies/service-proxies';
...
@Component({
  selector: 'app-order-double-confirm',
  templateUrl: './order-double-confirm.component.html',
  styles: [
  ]
})
export class OrderDoubleConfirmComponent extends PagedListingComponentBase<AuditOutOrderMasterItemDto> implements OnInit {
  ...
  protected fetchData(request: PagedRequestDto, pageNumber: number, finishedCallback: Function): void {
    ...
    this.stockoutOrderServiceProxy
      .getDoubleConfirm(this.userName,
        this.warehouseId,
        this.audited,
      ...
      buttons: [
        {
          ...
          pop: '你确定要审核不通过吗？',
          type: 'del',
          iif: (item: AuditOutOrderMasterItemDto) => item.doubleConfirmed == OutOrderMasterItemStatues.待审核,
          click: (record: any) => {
  ...
  protected audit(entity: AuditOutOrderMasterItemDto, status: OutOrderMasterItemStatues): void {
    ...
    this.stockoutOrderServiceProxy.doubleConfirmEd(body)
      .subscribe(res => {
        this.refresh();
      });
  }
