...
import { OutOrderDto, OutOrderStatusEnum, OutOrderTypeEnum, StockoutOrderServiceProxy } from '@shared/service-proxies/service-proxies';
...
@Component({
  selector: 'app-all-out-order',
  templateUrl: './all-out-order.component.html',
  styles: [
  ]
})
export class AllOutOrderComponent extends PagedListingComponentBase<OutOrderDto> implements OnInit {
