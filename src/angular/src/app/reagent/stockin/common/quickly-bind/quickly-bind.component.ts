...
import { NormalReagentStockListDto } from '@shared/service-proxies/service-proxies';

@Component({
  selector: 'app-quickly-bind',
  templateUrl: './quickly-bind.component.html',
  styles: [
  ]
})
export class QuicklyBindComponent extends ModalComponentBase implements OnInit {

  @Input()
  i: NormalReagentStockListDto;
